...
export default function JobCard({ isSelected, onSelect }: Props) {
  return (
    <div
      className={`w-[447px] h-[327px] px-6 py-4 bg-white rounded-2xl shadow-md hover:shadow-xl ${isSelected ? 'selectCard' : ''}`}
      onClick={onSelect}>
