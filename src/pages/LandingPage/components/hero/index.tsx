...
export default function Hero() {
  return (
    <section className="h-[683px] flex flex-col justify-center items-center gap-10 bg-[#f1f2fd] lg:flex-row lg:gap-16 md:gap-y-4 md:text-center sm:gap-y-3 sm:text-center">
      <div className=" md:w-[500px] lg:w-[697px] h-[150px] text-4xl leading-snug md:text-6xl font-semibold tracking-tight capitalize text-custom-blue css-animation lg:text-7xl lg:leading-[98.5px] lg:ml-16 lg:h-[295px] ">
        <p>Kết Nối Việc Làm,</p>
        <p>Cơ Hội Mới,</p>
        <p>Cuộc Sống Mới</p>
      </div>
      <div className="mt-12 lg:mt-5 lg:mr-16 lg:w-[497px] lg:h-[497px] md:mt-36">
