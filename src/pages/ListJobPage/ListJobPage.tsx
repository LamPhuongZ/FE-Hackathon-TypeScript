  ...
  return (
    <div className="grid grid-cols-[447px_minmax(0,_1fr)] gap-x-7 py-4 px-[72px]">
      ...
      <div className="bg-white rounded-2xl shadow-md py-12 px-7">
        ...
        <button className="w-full rounded-2xl bg-[#3F8CFF] shadow-lg px-[337px] py-[28px] text-white text-2xl font-bold mt-9">
          Ứng tuyển
        </button>
        <div>
          <textarea
        ...
        <div className="my-7">
          <h1 className="text-xl mb-2">Địa chỉ làm việc:</h1>
        ...
        <div className="flex justify-between my-7">
          <div className="w-[300px] 2xl:w-[600px]">
            <h1 className="text-xl mb-2">Số điện thoại:</h1>
            <div className="h-14 flex items-center justify-center border border-solid rounded-[20px] ">
              <p className="text-xl font-medium">1234-567-890</p>
            </div>
          </div>
          <div className="w-[300px] 2xl:w-[600px]">
            <h1 className="text-xl mb-2">Người liên hệ:</h1>
            <div className="h-14 flex items-center justify-center border border-solid rounded-[20px] ">
        ...
        <div className="flex justify-between my-10">
          <div className="w-[300px] 2xl:w-[600px]">
            <h1 className="text-xl mb-2">Ngày bắt đầu làm việc:</h1>
            <div className="h-14 flex items-center justify-center border border-solid rounded-[20px] ">
        ...
        <div className="mt-[30px]">
          <div className="w-[840px] h-[350px] 2xl:w-full">
            <img
          ...
          <div>
            ...
            <div className="border border-solid rounded-[20px] px-[26px] py-[18px]">
              <p className="text-[20px] font-medium text-[#91929E]">
